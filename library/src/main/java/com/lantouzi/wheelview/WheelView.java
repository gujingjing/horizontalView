...
public class WheelView extends View implements GestureDetector.OnGestureListener {
	 ...
	 * 2016/1/18 addBy gjj
	 * lwvshowLine  是否显示虚线
	 * lwvshowTopIcon  是否显示顶部指示
	 */
	private boolean lwvshowLine=false,lwvshowTopIcon=false;
	...
	protected void init(AttributeSet attrs) {
		...
		if (ta != null) {
			 ...
			 * 2016/1/18 addBy gjj
			 */
			lwvshowLine=ta.getBoolean(R.styleable.lwvWheelView_lwvshowLine,lwvshowLine);
			lwvshowTopIcon=ta.getBoolean(R.styleable.lwvWheelView_lwvshowTopIcon,lwvshowTopIcon);
		}
